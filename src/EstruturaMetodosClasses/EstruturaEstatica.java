package EstruturaMetodosClasses;
...
public class EstruturaEstatica <T> {
    ...
    //esse método é pra ler nas outras classes de pilha, filas? tem que ficar public
    ...
    //esse pode ser protected para os outros métodos não lerem ele, pois ele é só pra vetor!
    protected boolean adiciona(int posicao, T elemento){

        //Ja vamos aproveitar o algoritmo do método de busca abaixo
        if (!(posicao >= 0 && posicao < tamanho)) {
            throw new ArrayIndexOutOfBoundsException("Você digitou uma posição invalida!, ou que excede o array!");
        }
